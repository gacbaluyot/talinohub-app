  ...
  <div>
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-xl font-semibold  text-black">Blogs</h1>
        <p class="mt-2 text-sm text-gray-600">A list of all blogs including their title, content, and author.</p>
      </div>
    ...
    <div v-if="blogsStore.loading" class="mt-8 text-center">
      ...
      <p class="mt-2 text-sm text-gray-700 ">Loading blogs...</p>
    </div>
              ...
              <td class="py-4 pl-4 pr-3 sm:pl-6">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <div class="text-sm text-gray-500">{{ blog?.user?.name || 'Unknown Author' }}</div>
                  </div>
                </div>
              </td>
              <td class="whitespace-nowrap px-3 py-4">
                <div class="flex items-center text-sm text-gray-500">
                  <svg class="mr-1.5 h-5 w-5 shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
