  ...
  <Dialog v-model="isVisible" size="sm">
    <DialogHeader>
      <div class="flex items-center gap-3">
        ...
        <div>
          <h3 class="text-xl font-bold text-surface-900 dark:text-surface-0">Delete Course</h3>
    ...
    <DialogContent>
      <div class="space-y-4">
        ...
        <p class="text-sm text-surface-600 dark:text-surface-400">
          This will permanently delete the course and all its lessons. Students enrolled in this course will lose access.
        </p>
...
const handleDelete = async () => {
  ...
  try {
    await coursesStore.deleteCourse(props.course.id)
    emit('deleted')
    emit('close')
  } catch (err: any) {
