          ...
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                />
                <label for="remember-me" class="ml-3 block text-sm leading-6 text-surface-900 dark:text-surface-0">
                  Remember me
                </label>
              </div>
          ...
          <div class="mt-10">
            <div class="relative">
              ...
              <div class="relative flex justify-center text-sm font-medium leading-6">
                <span class="bg-white px-6 text-surface-900 dark:text-surface-0">Or continue with</span>
              </div>
            </div>
